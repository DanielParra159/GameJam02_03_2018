...
public partial class Contexts : Entitas.IContexts {
    ...
    public FallesContext falles { get; set; }
    public GameContext game { get; set; }
    public InputContext input { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { falles, game, input }; } }

    public Contexts() {
        falles = new FallesContext();
